...
class osc5Request extends FormRequest
{
    ...
    { 
        return [
            ...
            //'osc_desc.required'    => 'El nombre de la IAP es obligatorio.',
            //'osc_desc.min'         => 'El nombre de la IAP es de mínimo 1 caracter.',
            //'osc_desc.max'         => 'El nombre de la IAP es de máximo 100 caracteres.',
            ...
            'juridica_id.required'   => 'La figura jurídica es obligatoria.',
            'osc_regcons.required'   => 'El registro de constitución es obligatorio.',
            'osc_regcons.min'        => 'El registro de constitución es de mínimo 1 caracter.',
            'osc_regcons.max'        => 'El registro de constitución es de máximo 50 caracteres.',
            ...
            'anio_id.required'       => 'La vigencia en años es obligatoria.',
    ...
    public function rules()
    {
        return [
            ...
            //'osc_status'   => 'required'
            //'osc_foto1'    => 'required|image',
            //'osc_foto2'    => 'required|image'
