...
class informeController extends Controller
{
    ...
    public function actionBuscarInforme(Request $request)
    {
        ...
        $totactivs    = regprogtrabModel::join('ONG_PROGRAMA_DTRABAJO','ONG_PROGRAMA_DTRABAJO.FOLIO', '=', 
                                                                       'ONG_PROGRAMA_ETRABAJO.FOLIO')
                        ->select(   'ONG_PROGRAMA_ETRABAJO.PERIODO_ID','ONG_PROGRAMA_ETRABAJO.FOLIO')
                        ->selectRaw('COUNT(*) AS TOTACTIVIDADES')
                        ->groupBy(  'ONG_PROGRAMA_ETRABAJO.PERIODO_ID','ONG_PROGRAMA_ETRABAJO.FOLIO')
                        ->get();                             
        //**************************************************************//
        ...
        return view('sicinar.informelabores.verInformes', compact('nombre','usuario','regosc','reganios','regperiodos','regmeses','regdias','regprogtrab','totactivs'));
    }
    ...
    public function actionVerInformes(){
        ...
        return view('sicinar.informelabores.verInformes',compact('nombre','usuario','regosc','reganios','regperiodos','regmeses','regdias','regprogtrab','regprogdtrab','totactivs')); 
    ...
    public function actionAltaNuevoProgtrab(Request $request){
        ...
        if($duplicado->count() >= 1)
            ...
            $nuevoprogtrab->FECHA_ELAB3   = date('Y/m/d', strtotime(trim($dia1[0]->dia_desc.'/'.$mes1[0]->mes_mes.'/'.$request->periodo_id1) ));
    ...
    public function actionActualizarProgtrab(progtrabRequest $request, $id){
        ...
        if($regprogtrab->count() <= 0)
            ...
            if(!empty($request->periodo_d1) and !empty($request->mes_d1) and !empty($request->dia_d1) ){
                ...
                $mes1 = regMesesModel::ObtMes($request->mes_id1);
                $dia1 = regDiasModel::ObtDia($request->dia_id1);                
                //xosc_feccons = $dia1[0]->dia_desc.'/'.$mes1[0]->mes_mes.'/'.$request->periodo_id1;
            }   //endif
            $mes1 = regMesesModel::ObtMes($request->mes_id1);
            $dia1 = regDiasModel::ObtDia($request->dia_id1);                
    ...
    public function actionExportInformePdf($id,$id2){
        ...
        $regprogdtrab=regProgdtrabModel::join('ONG_CAT_UNID_MEDIDA' ,'ONG_CAT_UNID_MEDIDA.UMEDIDA_ID','=',
                                                                    'ONG_PROGRAMA_DTRABAJO.UMEDIDA_ID')
                ->select('ONG_PROGRAMA_DTRABAJO.PARTIDA', 
                         ...
                         'ONG_PROGRAMA_DTRABAJO.MESC_01', 'ONG_PROGRAMA_DTRABAJO.MESC_02', 'ONG_PROGRAMA_DTRABAJO.MESC_03', 
                         'ONG_PROGRAMA_DTRABAJO.MESC_04', 'ONG_PROGRAMA_DTRABAJO.MESC_05', 'ONG_PROGRAMA_DTRABAJO.MESC_06', 
                         'ONG_PROGRAMA_DTRABAJO.MESC_07', 'ONG_PROGRAMA_DTRABAJO.MESC_08', 'ONG_PROGRAMA_DTRABAJO.MESC_09', 
                         'ONG_PROGRAMA_DTRABAJO.MESC_10', 'ONG_PROGRAMA_DTRABAJO.MESC_11', 'ONG_PROGRAMA_DTRABAJO.MESC_12'
                            )
                ->selectRaw('(ONG_PROGRAMA_DTRABAJO.MESP_01+ONG_PROGRAMA_DTRABAJO.MESP_02+ONG_PROGRAMA_DTRABAJO.MESP_03+
                              ...
                              ONG_PROGRAMA_DTRABAJO.MESP_10+ONG_PROGRAMA_DTRABAJO.MESP_11+ONG_PROGRAMA_DTRABAJO.MESP_12)
                              META_PROGRAMADA')
                ->selectRaw('(ONG_PROGRAMA_DTRABAJO.MESC_01+ONG_PROGRAMA_DTRABAJO.MESC_02+ONG_PROGRAMA_DTRABAJO.MESC_03+
                              ONG_PROGRAMA_DTRABAJO.MESC_04+ONG_PROGRAMA_DTRABAJO.MESC_05+ONG_PROGRAMA_DTRABAJO.MESC_06+
                              ONG_PROGRAMA_DTRABAJO.MESC_07+ONG_PROGRAMA_DTRABAJO.MESC_08+ONG_PROGRAMA_DTRABAJO.MESC_09+
                              ONG_PROGRAMA_DTRABAJO.MESC_10+ONG_PROGRAMA_DTRABAJO.MESC_11+ONG_PROGRAMA_DTRABAJO.MESC_12)
                              META_REALIZADA')                
                ->where(  'ONG_PROGRAMA_DTRABAJO.FOLIO'     ,$id2)
                ->orderBy('ONG_PROGRAMA_DTRABAJO.PERIODO_ID','ASC')                   
                ->orderBy('ONG_PROGRAMA_DTRABAJO.FOLIO'     ,'ASC')
                ->orderBy('ONG_PROGRAMA_DTRABAJO.PARTIDA'   ,'ASC')
                ->get();    
        ...
        if($regprogdtrab->count() <= 0){
            ...
            $pdf = PDF::loadView('sicinar.pdf.InformePdf',compact('nombre','usuario','regumedida','regosc','regprogtrab','regprogdtrab'));
            //$options = new Options();
    ...
    public function IapxEdo(){
        ...
        $regtotxedo=regOscModel::join('ONG_CAT_ENTIDADES_FED',[['ONG_CAT_ENTIDADES_FED.ENTIDADFEDERATIVA_ID','=','ONG_IAPS.ENTIDADFEDERATIVA_ID'],['ONG_IAPS.OSC_ID','<>',0]])
                         ->selectRaw('COUNT(*) AS TOTALXEDO')
                               ->get();

        $regosc=regOscModel::join('ONG_CAT_ENTIDADES_FED',[['ONG_CAT_ENTIDADES_FED.ENTIDADFEDERATIVA_ID','=','ONG_IAPS.ENTIDADFEDERATIVA_ID'],['ONG_IAPS.OSC_ID','<>',0]])
                      ->selectRaw('ONG_IAPS.ENTIDADFEDERATIVA_ID, ONG_CAT_ENTIDADES_FED.ENTIDADFEDERATIVA_DESC AS ESTADO, COUNT(*) AS TOTAL')
                        ->groupBy('ONG_IAPS.ENTIDADFEDERATIVA_ID', 'ONG_CAT_ENTIDADES_FED.ENTIDADFEDERATIVA_DESC')
                        ->orderBy('ONG_IAPS.ENTIDADFEDERATIVA_ID','asc')
                        ->get();
    ...
    public function IapxMpio(){
        ...
        $regtotxmpio=regOscModel::join('ONG_CAT_MUNICIPIOS_SEDESEM',[['ONG_CAT_MUNICIPIOS_SEDESEM.ENTIDADFEDERATIVAID','=',15],
                                                            ['ONG_CAT_MUNICIPIOS_SEDESEM.MUNICIPIOID','=','ONG_IAPS.MUNICIPIO_ID'],['ONG_IAPS.OSC_ID','<>',0]])
                         ->selectRaw('COUNT(*) AS TOTALXMPIO')
                               ->get();
        $regosc=regOscModel::join('ONG_CAT_MUNICIPIOS_SEDESEM',[['ONG_CAT_MUNICIPIOS_SEDESEM.ENTIDADFEDERATIVAID','=',15],
                                                            ['ONG_CAT_MUNICIPIOS_SEDESEM.MUNICIPIOID','=','ONG_IAPS.MUNICIPIO_ID'],['ONG_IAPS.OSC_ID','<>',0]])
                      ->selectRaw('ONG_IAPS.MUNICIPIO_ID, ONG_CAT_MUNICIPIOS_SEDESEM.MUNICIPIONOMBRE AS MUNICIPIO,COUNT(*) AS TOTAL')
                        ->groupBy('ONG_IAPS.MUNICIPIO_ID', 'ONG_CAT_MUNICIPIOS_SEDESEM.MUNICIPIONOMBRE')
                        ->orderBy('ONG_IAPS.MUNICIPIO_ID','asc')
                        ->get();
        //dd($procesos);
    ...
    public function IapxRubro(){
        ...
        $regtotxrubro=regOscModel::join('ONG_CAT_RUBROS','ONG_CAT_RUBROS.UMEDIDA_ID','=','ONG_IAPS.UMEDIDA_ID')
                      ->selectRaw('COUNT(*) AS TOTALXRUBRO')
                            ->get();
        $regosc=regOscModel::join('ONG_CAT_RUBROS','ONG_CAT_RUBROS.UMEDIDA_ID','=','ONG_IAPS.UMEDIDA_ID')
                      ->selectRaw('ONG_IAPS.UMEDIDA_ID,  ONG_CAT_RUBROS.RUBRO_DESC AS RUBRO, COUNT(*) AS TOTAL')
                        ->groupBy('ONG_IAPS.UMEDIDA_ID','ONG_CAT_RUBROS.RUBRO_DESC')
                        ->orderBy('ONG_IAPS.UMEDIDA_ID','asc')
                        ->get();
        //$procesos = procesosModel::join('SCI_TIPO_PROCESO','SCI_PROCESOS.CVE_TIPO_PROC','=','SCI_TIPO_PROCESO.CVE_TIPO_PROC')
        //    ->selectRaw('SCI_TIPO_PROCESO.DESC_TIPO_PROC AS TIPO, COUNT(SCI_PROCESOS.CVE_TIPO_PROC) AS TOTAL')
        //    ->groupBy('SCI_TIPO_PROCESO.DESC_TIPO_PROC')
    ...
    public function actionVerInformelab($id){
        ...
        return view('sicinar.informelabores.verInformelab',compact('nombre','usuario','regosc','regumedida','reganios','regperiodos','regmeses','regdias','regprogtrab','regprogdtrab'));
    }
    ...
    public function actionEditarInformelab($id,$id2){
        ...
        //return view('sicinar.programatrabajo.editarProgtrab',compact('nombre','usuario','regosc','regumedida','reganios','regperiodos','regmeses','regdias','regprogtrab'));
        return view('sicinar.informelabores.editarInformelab',compact('nombre','usuario','regosc','reganios','regperiodos','regmeses','regdias','regprogtrab','regprogdtrab','regumedida'));
