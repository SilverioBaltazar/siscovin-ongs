...
class padronController extends Controller
{
    ...
    public function actionBuscarPadron(Request $request)
    {
        ...
        $regservicios = regServicioModel::join('ONG_CAT_RUBROS','ONG_CAT_RUBROS.RUBRO_ID', '=', 
                                                                'ONG_CAT_SERVICIOS.RUBRO_ID')
                        ->select('ONG_CAT_SERVICIOS.SERVICIO_ID','ONG_CAT_SERVICIOS.SERVICIO_DESC',
                                 'ONG_CAT_RUBROS.RUBRO_DESC')
                        ->get();                          
        ...
        //$bio   = $request->get('bio');    
        $regpadron= regPadronModel::orderBy('OSC_ID', 'ASC')
    ...
    public function actionnuevoPadron(){
        ...
        $regservicios = regServicioModel::join('ONG_CAT_RUBROS',  'ONG_CAT_RUBROS.RUBRO_ID', '=', 
                        ...
                        ->select( 'ONG_CAT_SERVICIOS.SERVICIO_ID','ONG_CAT_SERVICIOS.SERVICIO_DESC',
                                  'ONG_CAT_RUBROS.RUBRO_DESC')
                        ->orderBy('ONG_CAT_SERVICIOS.SERVICIO_DESC','ASC')
                        ->orderBy('ONG_CAT_RUBROS.RUBRO_DESC','ASC')
                        ->get();                             
        ...
        $regpadron    = regPadronModel::select('PERIODO_ID','PROGRAMA_ID','FOLIO','OSC_ID','PRIMER_APELLIDO',
    ...
    public function actionActualizarPadron(padronRequest $request, $id){
        ...
        if($regpadron->count() <= 0)
            ...
            $regpadron = regPadronModel::where('FOLIO',$id)        
                ...
                'CURP'            => substr(strtoupper(trim($request->curp)),0,17),
                'SEXO'            => $request->sexo,
                //'FECHA_NACIMIENTO'=> date('Y/m/d', strtotime($request->fecha_nacimiento)), //$request->OSC_feccons
    ...
    public function actionPadronxEdo(){
        ...
        $regtotxedo=regPadronModel::join('ONG_CAT_ENTIDADES_FED','ONG_CAT_ENTIDADES_FED.ENTIDADFEDERATIVA_ID','=',
                                                                 'ONG_METADATO_PADRON.ENTIDAD_FED_ID')
                    ->selectRaw('COUNT(*) AS TOTALXEDO')
                    ->get();
        $regpadron =regPadronModel::join('ONG_CAT_ENTIDADES_FED','ONG_CAT_ENTIDADES_FED.ENTIDADFEDERATIVA_ID','=',
                                                                 'ONG_METADATO_PADRON.ENTIDAD_FED_ID')
                      ->selectRaw('ONG_METADATO_PADRON.ENTIDAD_FED_ID, 
                                   ONG_CAT_ENTIDADES_FED.ENTIDADFEDERATIVA_DESC AS ESTADO, COUNT(*) AS TOTAL')
                      ->groupBy('ONG_METADATO_PADRON.ENTIDAD_FED_ID','ONG_CAT_ENTIDADES_FED.ENTIDADFEDERATIVA_DESC')
                      ->orderBy('ONG_METADATO_PADRON.ENTIDAD_FED_ID','asc')
                      ->get();
        //dd($procesos);
    ...
    public function actionPadronxMpio(){
        ...
        $regtotxmpio=regPadronModel::join('ONG_CAT_MUNICIPIOS_SEDESEM',
                                     [['ONG_CAT_MUNICIPIOS_SEDESEM.ENTIDADFEDERATIVAID','=',15],
                                      ['ONG_CAT_MUNICIPIOS_SEDESEM.MUNICIPIOID','=','ONG_METADATO_PADRON.MUNICIPIO_ID']
                                      ])
                         ->selectRaw('COUNT(*) AS TOTALXMPIO')
                               ->get();
        $regpadron=regPadronModel::join('ONG_CAT_MUNICIPIOS_SEDESEM',
                                      [['ONG_CAT_MUNICIPIOS_SEDESEM.ENTIDADFEDERATIVAID','=',15],
                                       ['ONG_CAT_MUNICIPIOS_SEDESEM.MUNICIPIOID','=','ONG_METADATO_PADRON.MUNICIPIO_ID']
                                      ])
                      ->selectRaw('ONG_METADATO_PADRON.MUNICIPIO_ID,  ONG_CAT_MUNICIPIOS_SEDESEM.MUNICIPIONOMBRE AS MUNICIPIO,COUNT(*) AS TOTAL')
                        ->groupBy('ONG_METADATO_PADRON.MUNICIPIO_ID','ONG_CAT_MUNICIPIOS_SEDESEM.MUNICIPIONOMBRE')
                        ->orderBy('ONG_METADATO_PADRON.MUNICIPIO_ID','asc')
                        ->get();
        //dd($procesos);
    ...
    public function actionPadronxServicio(){
        ...
        $regtotales=regPadronModel::join('ONG_CAT_SERVICIOS','ONG_CAT_SERVICIOS.SERVICIO_ID',  '=',
                                                             'ONG_METADATO_PADRON.SERVICIO_ID')
                    ->selectRaw('COUNT(*) AS TOTAL')
                    ->get();
        $regpadron =regPadronModel::join('ONG_CAT_SERVICIOS','ONG_CAT_SERVICIOS.SERVICIO_ID','=',
                                                             'ONG_METADATO_PADRON.SERVICIO_ID')
                    ->selectRaw('ONG_METADATO_PADRON.SERVICIO_ID, 
                                 ONG_CAT_SERVICIOS.SERVICIO_DESC AS SERVICIO, COUNT(*) AS TOTAL')
                    ->groupBy('ONG_METADATO_PADRON.SERVICIO_ID','ONG_CAT_SERVICIOS.SERVICIO_DESC')
                    ->orderBy('ONG_METADATO_PADRON.SERVICIO_ID','asc')
                    ->get();
        //dd($regpadron);
