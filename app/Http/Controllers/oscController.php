...
class oscController extends Controller
{
    ...
    public function actionBuscarOsc(Request $request)
    {
        ...
        $regmunicipio = regMunicipioModel::join('ONG_CAT_ENTIDADES_FED',
                        ...
                        ->wherein('ONG_CAT_MUNICIPIOS_SEDESEM.ENTIDADFEDERATIVAID',[9, 11, 15, 22])
        ...
        return view('sicinar.osc.verOsc', compact('nombre','usuario','regosc','regentidades','regmunicipio','regrubro','regvigencia','reginmuebles','regtotactivas','regtotinactivas','regperiodos','regmeses','regdias','regfigurajur'));
    }
    ...
    public function actionVerOsc(){
        ...
        $regosc       = regOscModel::select('OSC_ID','OSC_DESC','OSC_CALLE','OSC_NUM','OSC_DOM1','OSC_DOM2','OSC_DOM3',
                                     'OSC_COLONIA','MUNICIPIO_ID','ENTIDADFEDERATIVA_ID','RUBRO_ID','FIGJURIDICA_ID','OSC_REGCONS',
    ...
    public function actionNuevaOsc(){
        ...
        //dd($unidades);
        return view('sicinar.osc.nuevaOsc',compact('regrubro','regmunicipio','regentidades','regosc','nombre','usuario','regvigencia','reginmuebles','regperiodos','regmeses','regdias','regfigurajur'));
    }
    ...
    public function actionAltaNuevaOsc(Request $request){
        ...
        $nuevaiap->FIGJURIDICA_ID=$request->juridica_id;
    ...
    public function actionVerOsc5(){
        ...
        return view('sicinar.osc.verOsc5',compact('nombre','usuario','regosc','regentidades','regmunicipio','regrubro','regvigencia','reginmuebles','regperiodos','regmeses','regdias','regfigurajur'));
    }
    ...
    public function actionEditarOsc($id){
        ...
        return view('sicinar.osc.editarOsc',compact('nombre','usuario','regosc','regentidades','regmunicipio','regrubro','regvigencia','reginmuebles','regperiodos','regmeses','regdias','regfigurajur'));
    ...
    public function actionActualizarOsc(oscRequest $request, $id){
        ...
        if($regosc->count() <= 0)
            ...
            //dd('JURIDICO.......:'.$request->juridica_id);
            $regosc = regOscModel::where('OSC_ID',$id)        
                      ->update([                
                ...
                'FIGJURIDICA_ID'  => $request->juridica_id,
    ...
    public function actionEditarOsc5($id){
        ...
        return view('sicinar.osc.editarOsc5',compact('nombre','usuario','regosc','regentidades','regmunicipio','regrubro','regvigencia','reginmuebles','regperiodos','regmeses','regdias','regfigurajur'));
    ...
    public function OscxEdo(){
        ...
        $regtotxedo=regOscModel::join('ONG_CAT_ENTIDADES_FED',[['ONG_CAT_ENTIDADES_FED.ENTIDADFEDERATIVA_ID','=','ONGS.ENTIDADFEDERATIVA_ID'],['ONGS.OSC_ID','<>',0]])
                         ->selectRaw('COUNT(*) AS TOTALXEDO')
                               ->get();

        $regosc=regOscModel::join('ONG_CAT_ENTIDADES_FED',[['ONG_CAT_ENTIDADES_FED.ENTIDADFEDERATIVA_ID','=','ONGS.ENTIDADFEDERATIVA_ID'],['ONGS.OSC_ID','<>',0]])
    ...
    public function Bitacora(Request $request){
        ...
        $regbitatxmes=regBitacoraModel::join('ONG_CAT_PROCESOS' ,'ONG_CAT_PROCESOS.PROCESO_ID' ,'=','ONG_BITACORA.PROCESO_ID')
                                 ...
                                 ->where(    'ONG_BITACORA.PERIODO_ID',$request->periodo_id)
        ...
        $regbitacora=regBitacoraModel::join('ONG_CAT_PROCESOS' ,'ONG_CAT_PROCESOS.PROCESO_ID' ,'=','ONG_BITACORA.PROCESO_ID')
                                     ->join('ONG_CAT_FUNCIONES','ONG_CAT_FUNCIONES.FUNCION_ID','=','ONG_BITACORA.FUNCION_ID')
                                     ->join('ONG_CAT_TRX'      ,'ONG_CAT_TRX.TRX_ID'          ,'=','ONG_BITACORA.TRX_ID')
                    ->select(   'ONG_BITACORA.PERIODO_ID', 'ONG_BITACORA.PROCESO_ID','ONG_CAT_PROCESOS.PROCESO_DESC', 
                                'ONG_BITACORA.FUNCION_ID', 'ONG_CAT_FUNCIONES.FUNCION_DESC', 
                    ...
                    ->where(    'ONG_BITACORA.PERIODO_ID',$request->periodo_id)
                    ->groupBy(  'ONG_BITACORA.PERIODO_ID','ONG_BITACORA.PROCESO_ID','ONG_CAT_PROCESOS.PROCESO_DESC',
                                'ONG_BITACORA.FUNCION_ID','ONG_CAT_FUNCIONES.FUNCION_DESC', 
                                'ONG_BITACORA.TRX_ID'    ,'ONG_CAT_TRX.TRX_DESC')
                    ->orderBy(  'ONG_BITACORA.PERIODO_ID','asc')
                    ->orderBy(  'ONG_BITACORA.PROCESO_ID','asc')
                    ->orderBy(  'ONG_BITACORA.FUNCION_ID','asc')
                    ->orderBy(  'ONG_BITACORA.TRX_ID'    ,'asc')
                    ->get();
        //dd($procesos);
    ...
    public function actiongeorefxmpio(){
        ...
        $regosc=regOscModel::join(  'ONG_CAT_ENTIDADES_FED',     'ONG_CAT_ENTIDADES_FED.ENTIDADFEDERATIVA_ID','=',
                                                                'ONGS.ENTIDADFEDERATIVA_ID')
                           ->join(  'ONG_CAT_MUNICIPIOS_SEDESEM',[['ONG_CAT_MUNICIPIOS_SEDESEM.ENTIDADFEDERATIVAID','=',
                                                                'ONGS.ENTIDADFEDERATIVA_ID'],
                                                               ['ONG_CAT_MUNICIPIOS_SEDESEM.MUNICIPIOID'        ,'=',
                                                                'ONGS.MUNICIPIO_ID'],
                                                               ['ONGS.OSC_ID','<>',0]
                                                              ])
                        ->select(   'ONGS.ENTIDADFEDERATIVA_ID','ONG_CAT_ENTIDADES_FED.ENTIDADFEDERATIVA_DESC AS ENTIDAD',
                                    'ONGS.MUNICIPIO_ID',        'ONG_CAT_MUNICIPIOS_SEDESEM.MUNICIPIONOMBRE AS MUNICIPIO', 
                                    'ONG_CAT_MUNICIPIOS_SEDESEM.GEOREF_CABMPIO_LATDECIMAL', 
                                    'ONG_CAT_MUNICIPIOS_SEDESEM.GEOREF_CABMPIO_LONGDECIMAL')
    ...
    public function OscxMpio(){
        ...
        $regtotxmpio=regOscModel::join('ONG_CAT_MUNICIPIOS_SEDESEM',[['ONG_CAT_MUNICIPIOS_SEDESEM.ENTIDADFEDERATIVAID','=',15],
                                                            ['ONG_CAT_MUNICIPIOS_SEDESEM.MUNICIPIOID','=','ONGS.MUNICIPIO_ID'],['ONGS.OSC_ID','<>',0]])
    ...
    public function OscxFigjuridica(){
        $nombre       = session()->get('userlog');
        $pass         = session()->get('passlog');
        if($nombre == NULL AND $pass == NULL){
            return view('sicinar.login.expirada');
        ...
        $regtotxfigura=regOscModel::join('ONG_CAT_FIGJURIDICA','ONG_CAT_FIGJURIDICA.FIGJURIDICA_ID','=',
                                                               'ONGS.FIGJURIDICA_ID')
                      ->selectRaw('COUNT(*) AS TOTALXFIGJURIDICA')
                            ->get();
        $regosc       =regOscModel::join('ONG_CAT_FIGJURIDICA','ONG_CAT_FIGJURIDICA.FIGJURIDICA_ID','=',
                                                           'ONGS.FIGJURIDICA_ID')
                      ->selectRaw('ONGS.FIGJURIDICA_ID,  ONG_CAT_FIGJURIDICA.FIGJURIDICA_DESC AS FIGURA, 
                                   COUNT(*) AS TOTAL')
                        ->groupBy('ONGS.FIGJURIDICA_ID','ONG_CAT_FIGJURIDICA.FIGJURIDICA_DESC')
                        ->orderBy('ONGS.FIGJURIDICA_ID','asc')
                        ->get();
        //dd($procesos);
        return view('sicinar.numeralia.oscxfigjuridica',compact('regosc','regtotxfigura','nombre','usuario','rango'));
    }
    ...
    public function OscxRubro(){
        ...
        $regtotxrubro=regOscModel::join('ONG_CAT_RUBROS','ONG_CAT_RUBROS.RUBRO_ID','=','ONGS.RUBRO_ID')
                      ->selectRaw('COUNT(*) AS TOTALXRUBRO')
                            ->get();
        $regosc=regOscModel::join('ONG_CAT_RUBROS','ONG_CAT_RUBROS.RUBRO_ID','=','ONGS.RUBRO_ID')
