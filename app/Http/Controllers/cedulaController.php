...
class cedulaController extends Controller
{
    ...
    public function actionBuscarCedula(Request $request)
    {
        ...
        $bio   = $request->get('bio');    
        $regcedula   = regCedulaModel::orderBy('IAP_ID', 'ASC')
        ...
        //return view('sicinar.cedulas.verProgtrab', compact('nombre','usuario','regiap','regumedida','reganios','regperiodos','regmeses','regdias','regcedula'));
        return view('sicinar.cedulas.verCedula', compact('nombre','usuario','regiap','reganios','regperiodos','regmeses','regdias','regcedula'));
    }
...
public function actionVerCedula(){
        ...
        //$regumedida   = regArticulosModel::select('UMEDIDA_ID','UMEDIDA_DESC')
    ...
    public function actionBorrarCedulaArti($id,$id2,$id3){
        ...
        if($regcedulaarti->count() <= 0)
            ...
            toastr()->success('Cedula eliminada.','¡Ok!',['positionClass' => 'toast-bottom-right']);
