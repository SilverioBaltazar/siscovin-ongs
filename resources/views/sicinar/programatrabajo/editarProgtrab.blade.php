...
@section('content')
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                Menú
                <small>3. Requisitos asistenciales     </small>                
                <small>3.2 Programa de trabajo - editar </small>           
            </h1>
        </section>
                        ...
                        <div class="box-body">
                            <div class="row">   
                                <div class="col-xs-2 form-group">
                                    ...
                                    <td><label style="color:green; text-align:left; vertical-align: middle;">{{$regprogtrab->periodo_id}} </label></td>   
                                </div>                                
                                ...
                                <div class="col-xs-2 form-group">
                                    ...
                                    <label>Folio asignado </label><br>
                                    <td><label style="color:green; text-align:left; vertical-align: middle;">{{$regprogtrab->folio}}</label></td>    
                                </div>
                            </div>
