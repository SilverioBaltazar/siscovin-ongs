    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                ...
                <small>3.2 Programa de trabajo - editar actividad </small>           
            </h1>
        </section>
                            ...
                            <table id="tabla1" class="table table-hover table-striped">
                                ...
                                @foreach($regprogtrab as $progtrab)
                                    <td>   
                                        ...
                                        <label>Folio: </label>
                                        <label style="text-align:left; vertical-align: middle; color:green;"{{$progtrab->folio}}</label>
                                    </td>                                                                 
                                    <td>   
                                        <input type="hidden" id="periodo_id" name="periodo_id" value="{{$progtrab->periodo_id}}">
                                        <label>Periodo fiscal: </label>
                                        <label style="text-align:left; vertical-align: middle; color:green;">{{$progtrab->periodo_id}}</label>
                                    </td>
                                    <td> 
                                        ...
                                        @foreach($regosc as $osc)
                                            @if($osc->osc_id == $progtrab->osc_id)
                                                <label style="text-align:left; vertical-align: middle; color:green;">{{$osc->osc_desc}}</label>
                                                @break
                                            @endif
                                        @endforeach
                                    </td>
