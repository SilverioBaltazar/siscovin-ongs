        ...
        <section class="content">
            <div class="row">
                <div class="col-md-12">
                        ...
                        {!! Form::open(['route' => ['actualizarReqc2',$regcontable->osc_folio], 'method' => 'PUT', 'id' => 'actualizarReqc2', 'enctype' => 'multipart/form-data']) !!}
                        <div class="box-body">
                            <div class="row">
                            ...
                            <div class="row">
                                @if (!empty($regcontable->osc_d2)||!is_null($regcontable->osc_d2))   
                                    <div class="col-xs-4 form-group">
                                        ...
                                        <label ><a href="/images/{{$regcontable->osc_d2}}" class="btn btn-danger" title="Constancia de autorización para recibir donativos en formato PDF"><i class="fa fa-file-pdf-o"></i>PDF
                                    ...
                                    <div class="col-xs-4 form-group">
                                        ...
                                        <input type="file" class="text-md-center" style="color:red" name="osc_d2" id="osc_d2" placeholder="Subir archivo de constancia de autorización para recibir donativos en formato PDF" >
                                    </div>      
...
@section('request')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\reqcontablesRequest','#actualizarRec2') !!}
@endsection
