            ...
            <div class="row">
                <div class="col-md-13">
                    <div class="box box-success">
                        ...
                        {!! Form::open(['route' => ['actualizarIapj13',$regjuridico->iap_id], 'method' => 'PUT', 'id' => 'actualizarIapj13', 'enctype' => 'multipart/form-data']) !!}
                        <div class="box-body">
                            <div class="row">
                            ...
                            <div class="row">
                                @if (!empty($regjuridico->iap_d13)||!is_null($regjuridico->iap_d13))   
                                    <div class="col-xs-4 form-group">
                                        <label >Documento de registro en el IFREM en formato PDF</label><br>
                                        <label ><a href="/images/{{$regjuridico->iap_d13}}" class="btn btn-danger" title="Documento de registro en el IFREM en formato PDF"><i class="fa fa-file-pdf-o"></i>PDF
                                        </a>&nbsp;&nbsp;&nbsp;{{$regjuridico->iap_d13}}
                                        </label>
                                        <input type="hidden" name="doc_id13" id="doc_id13" value="17">
                                    </div>   
                                    <div class="col-xs-4 form-group">
                                        <label >Actualizar archivo de Documento de registro en el IFREM en formato PDF</label>
...
@section('request')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\iapsjuridicoRequest','#actualizarIapj13') !!}
@endsection
