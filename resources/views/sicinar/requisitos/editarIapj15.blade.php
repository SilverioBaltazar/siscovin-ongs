            ...
            <div class="row">
                <div class="col-md-14">
                    <div class="box box-success">
                        ...
                        {!! Form::open(['route' => ['actualizarIapj15',$regjuridico->iap_id], 'method' => 'PUT', 'id' => 'actualizarIapj15', 'enctype' => 'multipart/form-data']) !!}
                        <div class="box-body">
                            <div class="row">
                            ...
                            <div class="row">
                                @if (!empty($regjuridico->iap_d15)||!is_null($regjuridico->iap_d15))   
                                    <div class="col-xs-4 form-group">
                                        ...
                                        <label ><a href="/images/{{$regjuridico->iap_d15}}" class="btn btn-danger" title="Documento de última protocolización en formato PDF"><i class="fa fa-file-pdf-o"></i>PDF
                                        </a>&nbsp;&nbsp;&nbsp;{{$regjuridico->iap_d15}}
                                        </label>
                                        <input type="hidden" name="doc_id15" id="doc_id15" value="19">
                                    </div>   
                                    <div class="col-xs-4 form-group">
                                        <label >Actualizar archivo de documento de última protocolización en formato PDF</label>
                                        <input type="file" class="text-md-center" style="color:red" name="iap_d15" id="iap_d15" placeholder="Subir archivo de documento de última protocolización en formato PDF" >
                                    </div>      
                                @else     <!-- se captura archivo 1 -->
                                    <div class="col-xs-4 form-group">
                                        <label >Archivo de Documento de última protocolización en formato PDF</label>
                                        <input type="file" class="text-md-center" style="color:red" name="iap_d15" id="iap_d15" placeholder="Subir archivo de documento comprobatorio de situación del inmueble en formato PDF" >
                                        <input type="hidden" name="doc_id15" id="doc_id15" value="19">
                                    </div>                                                
                                @endif 
                                <div class="col-xs-4 form-group">
                                ...
                                <div class="col-xs-4 form-group">
                                    ...
                                    <select class="form-control m-bot15" name="num_id15" id="num_id15" required>
                                        ...
                                        @foreach($regnumeros as $numeros)
                                            @if($numeros->num_id == $regjuridico->num_id15)
...
@section('request')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\iapsjuridicoRequest','#actualizarIapj15') !!}
@endsection
