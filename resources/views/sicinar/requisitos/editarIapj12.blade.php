            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-success">
                        ...
                        {!! Form::open(['route' => ['actualizarIapj12',$regjuridico->iap_id], 'method' => 'PUT', 'id' => 'actualizarIapj12', 'enctype' => 'multipart/form-data']) !!}
                        <div class="box-body">
                            <div class="row">
                            ...
                            <div class="row">
                                @if (!empty($regjuridico->iap_d12)||!is_null($regjuridico->iap_d12))   
                                    <div class="col-xs-4 form-group">
                                        ...
                                        <label ><a href="/images/{{$regjuridico->iap_d12}}" class="btn btn-danger" title="Acta constitutiva en formato PDF"><i class="fa fa-file-pdf-o"></i>PDF
...
@section('request')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\iapsjuridicoRequest','#actualizarIapj12') !!}
@endsection
