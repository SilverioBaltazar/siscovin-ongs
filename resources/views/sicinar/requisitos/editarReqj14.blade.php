                            ...
                            <div class="row">
                                @if (!empty($regjuridico->osc_d14)||!is_null($regjuridico->osc_d14))   
                                    <div class="col-xs-6 form-group">
                                        <label >Currículum en formato PDF</label><br>
                                        <label ><a href="/images/{{$regjuridico->osc_d14}}" class="btn btn-danger" title="Documento comprobatorio de situación del inmueble en formato PDF"><i class="fa fa-file-pdf-o"></i>PDF
                                    ...
                                    <div class="col-xs-6 form-group">
                                        ...
                                        <input type="file" class="text-md-center" style="color:red" name="osc_d14" id="osc_d14" placeholder="Subir archivo de Documento comprobatorio de situación del inmueble en formato PDF" >
                                    </div>      
...
@section('request')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\reqjuridicoRequest','#actualizarJur14') !!}
@endsection
