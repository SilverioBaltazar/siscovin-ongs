        ...
        <div class="col-md-6">
          <div class="box box-success">
            <div class="box-header">
              <h3 class="box-title"><b>Estadística de Padrón de beneficiarios por estado</b></h3>
  ...
  <script type="text/javascript">
      ...
      function drawStuff() {
        ...
        var options = {
          ...
          chart: { title: 'Gráfica de padrón de beneficiarios por estado 2D',
                   subtitle: 'Cantidad de beneficiarios por Estado' },
