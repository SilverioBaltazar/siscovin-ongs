...
@section('title','Estadística por clase de empleado')
  ...
  <div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Por clase de empleado</li>
      </ol>
    </section>
        ...
        <div class="col-md-6">
          <div class="box box-success">
            <div class="box-header">
              <h3 class="box-title"><b>Estadística de Personal por clase de empleado</b></h3>
              ...
              <table id="tabla1" class="table table-striped table-bordered table-sm">
                <thead style="color: brown;" class="justify">
                  <tr>
                    ...
                    <th rowspan="2" style="text-align:left;"  >CLASE DE EMPLEADO</th>
                ...
                <tbody>
                  @foreach($regpersonal as $claseemp)
                    <tr>
                      <td style="color:darkgreen;">{{$claseemp->claseemp_id}}</td>
                      <td style="color:darkgreen;">{{$claseemp->clase_empleado}}   </td>
                      <td style="color:darkgreen; text-align:center;">{{$claseemp->total}}   </td>
                    </tr>
                  @endforeach
...
@section('javascrpt')
  ...
  <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['id', 'Clase de empleado'],
          @foreach($regpersonal as $claseemp)
             ['{{$claseemp->clase_empleado}}', {{$claseemp->total}} ],
          @endforeach
          //['Work',     11],
          //['Eat',      2],
          //['Commute',  2],
        ...
        var options = {
          title: 'Plantilla de personal por clase de empleado',
      ...
      function drawStuff() {
        ...
        var options = {
          ...
          chart: { title: 'Gráfica de Barras',
                   subtitle: 'Plantilla de personal por clase de empleado' },
  ...
  <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var options = {
          title: 'Gráfica por Clase de empleado',
          pieHole: 0.4,
          width: 700,                   // Ancho de la pantalla horizontal
          height: 500,                  // Alto de la pantall '75%',
        };
