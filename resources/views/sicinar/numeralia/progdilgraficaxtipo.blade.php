  ...
  <div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Programa de visitas de verificación </li>
      </ol>
    </section>
        ...
        <div class="col-md-6">
          <div class="box box-success">
            <div class="box-header">
              <h3 class="box-title"><b>Por tipo de visita  </b></h3>
...
@section('javascrpt')
  ...
  <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var options = {
          title: 'Programa de visitas de verificación por tipo de visita',
  ...
  <script type="text/javascript">
      ...
      function drawStuff() {
        ...
        var options = {
          ...
          height: 200,                  // Alto de la pantall '75%',          
