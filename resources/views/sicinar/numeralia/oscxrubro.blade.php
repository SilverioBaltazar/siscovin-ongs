        ...
        <div class="col-md-6">
          <div class="box box-success">
            <div class="box-header">
              <h3 class="box-title"><b>Por Rubro Social</b></h3>
                ...
                <tbody>
                  ...
                  @foreach($regtotxrubro as $totales)
                    <tr>
                        ...
                        <td style="color:green; text-align:center;"><b>{{number_format($totales->totalxrubro,0)}} </b></td>                      
                    </tr>
                  @endforeach
                </tbody>
              </table>
      ...
      function drawStuff() {
        ...
        var options = {
          ...
          chart: { title: 'Gráfica de Barras',
                   subtitle: 'OSC por Rubro Social' },
          bars: 'horizontal', // Required for Material Bar Charts.
          axes: {
            x: {
              //0: { side: 'top', label: 'Total de ONGS'} // Top x-axis.
              1: { side: 'top', label: 'Total OSC'} // Top x-axis.
            }
          },
          bar: { groupWidth: "90%" }
        };
