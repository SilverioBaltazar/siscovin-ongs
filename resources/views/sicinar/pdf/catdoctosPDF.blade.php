...
@section('content')
    ...
    <table class="table table-sm" align="center">
        <thead>        
        <tr>
            <th style="background-color:darkgreen;text-align:center;vertical-align: middle;"><b style="color:white;font-size: x-small;">id.<br>Doc.</b>
            </th>
            <th style="background-color:darkgreen;text-align:left;"><b style="color:white;font-size: x-small;">Documento</b>
            </th>
            <th style="background-color:darkgreen;text-align:left;"><b style="color:white;font-size: x-small;">Nombre del archivo</b>
            </th>
             <th style="background-color:darkgreen;text-align:left;"><b style="color:white;font-size: x-small;">Area que solicita </b>
            </th>  
            ...
            <th style="background-color:darkgreen;text-align:left;"><b style="color:white;font-size: x-small;">Frec.<br>entrega<br>anual</b>
            </th>                                    
        ...
        <tbody>
            @foreach($regdocto as $docto)
                <tr>
                    ...
                    <td style="text-align:center;vertical-align: middle;font-size:xx-small;">{{$docto->doc_desc}}</b>
                    </td>
                   <td style="text-align:left;vertical-align: middle;font-size:xx-small;">{{$docto->doc_file}}</b>
                    </td>                    
                    @foreach($dep as $depen)
                        @if($depen->depen_id == $docto->dependencia_id)
                            <td style="text-align:justify;vertical-align: middle;font-size:xx-small;">{{trim($depen->depen_desc)}}</b>
                            </td>
                        @endif
                    @endforeach       
