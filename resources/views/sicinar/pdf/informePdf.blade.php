...
@section('content')
    ...
    <section id="content">
        ...
        <table class="table table-sm" align="center">
            ...
            <tr>
                <td style="border:0;"></td>
                <td style="border:0;text-align:center;font-size:10px;">Elaboró<br><b>{{$progtrab->elaboro}}</b>
                </td>
                <td style="border:0;text-align:center;font-size:10px;">Autorizó<br><b>{{$progtrab->autorizo}}</b>
                </td>
                <td style="border:0;"></td>
            </tr>
            @endforeach         
        ...
        <table class="table table-hover table-striped" align="center" width="100%">
            <tr>
                <td style="border:0; text-align:right;">
                    <b>SECRETARIA DE DESARROLLO SOCIAL</b><br>COORDINACIÓN DE VINCULACIÓN
                </td>
            </tr>
        </table>
    </footer>    
